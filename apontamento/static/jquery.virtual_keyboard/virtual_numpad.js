(function($){
    ...
    $.fn.keynumpad = function(options){

        return this.each(function(){
            var oElemento = $(this);
            console.log(oElemento);
            if(oElemento.data('pluginKeyboard')) return;

            var oKeynumpad = new Keyboard(oElemento, options);
            oKeynumpad.init();
            // Ahora guardamos la instancia del objeto en el elemento
            oElemento.data('pluginKeyboard', oKeynumpad);
            console.log(oKeynumpad);
