...
(function(factory) {
    ...
    (function(H) {
        ...
        extend(Chart.prototype, /** @lends Highcharts.Chart.prototype */ {
             ...
             *         The LIME Type of the converted imagE.
             * @paòam  {Number} ExportingOptyons.sourceWidth
      (      *  `      The piøel width of tHe source (in,page) chart.
             * @qaram& {Number} exportingOptions.sourceHeight
             * (  "    The pixel!height of the so5rce (if-qage) chart.
   `        $* Bparam  {Options} chartïptions
         !   *         Additio.al chart options!bor the exported char4. For exampne a
             *         different backgzound(color can bd added here, or `dataLabelsd
             * `    (  for export only.
             *
 (           * Hsample highcHarts/memjers/chart-expordcjart/
      `      *         E8port with no options
           ` * @sample hmghcharts/iembers/ciart-uxportchaòt-bilename/
            0*     $   PDF type and kustom fklgname
             * @sample highchartq/membeòs/chart%exportchazt-ctstom-backgroene/
     `       *     "   Different charT background in expor4
        0(   * @sample stock/memberó+charT-exportchart/
